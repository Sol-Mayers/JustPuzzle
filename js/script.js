  ...
  for(let w of allWraps) {
    $(w).droppable({
      ...
      drop: function(event, ui) {
        if(jQuery(one).css('top') == '0px' && jQuery(one).css('left') == '0px' && jQuery(two).css('top') == '0px' && jQuery(two).css('left') == '136px' && jQuery(three).css('top') == '0px' && jQuery(three).css('left') == '272px' && jQuery(four).css('top') == '0px' && jQuery(four).css('left') == '408px' && jQuery(five).css('top') == '0px' && jQuery(five).css('left') == '544px' && jQuery(six).css('top') == '85px' && jQuery(six).css('left') == '0px' && jQuery(seven).css('top') == '85px' && jQuery(seven).css('left') == '136px' && jQuery(eight).css('top') == '85px' && jQuery(eight).css('left') == '272px' && jQuery(nine).css('top') == '85px' && jQuery(nine).css('left') == '408px' && jQuery(ten).css('top') == '85px' && jQuery(ten).css('left') == '544px' && (jQuery(eleven).css('top') == '170px' || jQuery(eleven).css('top') == '171px') && jQuery(eleven).css('left') == '0px' && (jQuery(twelve).css('top') == '170px' || jQuery(twelve).css('top') == '171px') && jQuery(twelve).css('left') == '136px' && (jQuery(thirteen).css('top') == '170px' || jQuery(thirteen).css('top') == '171px') && jQuery(thirteen).css('left') == '272px' && (jQuery(fourteen).css('top') == '170px' || jQuery(fourteen).css('top') == '171px') && jQuery(fourteen).css('left') == '408px' && (jQuery(fifteen).css('top') == '170px' || jQuery(fifteen).css('top') == '171px') && jQuery(fifteen).css('left') == '544px' && jQuery(sixteen).css('top') == '255px' && jQuery(sixteen).css('left') == '0px' && jQuery(seventeen).css('top') == '255px' && jQuery(seventeen).css('left') == '136px' && jQuery(eighteen).css('top') == '255px' && jQuery(eighteen).css('left') == '272px' && jQuery(nineteen).css('top') == '255px' && jQuery(nineteen).css('left') == '408px' && jQuery(twenty).css('top') == '255px' && jQuery(twenty).css('left') == '544px' && jQuery(twentyone).css('top') == '340px' && jQuery(twentyone).css('left') == '0px' && jQuery(twentytwo).css('top') == '340px' && jQuery(twentytwo).css('left') == '136px' && jQuery(twentythree).css('top') == '340px' && jQuery(twentythree).css('left') == '272px' && jQuery(twentyfour).css('top') == '340px' && jQuery(twentyfour).css('left') == '408px' && jQuery(twentyfive).css('top') == '340px' && jQuery(twentyfive).css('left') == '544px') {
          for(let s of allSquares) {
            s.style.boxShadow = 'none';
